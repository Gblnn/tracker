                ...
                <div style={{display:"flex", alignItems:"",marginLeft:"1rem",gap:"", flexFlow:"column", border:'', justifyContent:'center'}}>
                    ...
                    <div style={{border:"", display:'flex', height:"1.25rem", alignItems:'center', gap:"0.5rem"}}>
                        ...
                        transition={{duration:"0.5"}}>
                            <p style={{fontSize:"0.85rem", border:"",opacity:"", display:'flex', alignItems:'center', height:'', borderRadius:"0.5rem", background:"white", color:"black", padding:"0.25rem", paddingTop:"0.005rem", paddingBottom:"0.005rem", paddingLeft:"0.45rem",paddingRight:"0.5rem", fontWeight:"500", marginBottom:"0.1rem"}}>{props.subtitle}</p>
                        </motion.div>
                        :""
                    }
                    </div>
