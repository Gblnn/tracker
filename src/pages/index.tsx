    ...
    return(
        <div style={{padding:"1.5rem", background:"linear-gradient(rgba(18 18 80/ 65%), rgba(100 100 100/ 0%), rgba(100 100 100/ 0%))", height:"100svh"}}>
            <motion.div initial={{opacity:0}} whileInView={{opacity:1}}>
                <Back icon={<Indent color="salmon"/>} title="Index" noback extra={<button onClick={()=>window.location.reload()} style={{paddingLeft:"1rem", paddingRight:"1rem", fontSize:"0.8rem"}}><RefreshCwIcon width={"1rem"}/>Update<p style={{opacity:0.5, letterSpacing:"0.15rem"}}>v1.4</p></button>}/>
                <br/>
